...
│   └── ...
├── hooks/                    # Agent 钩子配置目录。可用来运行测试、格式化、创建翻译的字符串国际化，支持多种触发条件
...
- 记得持续优化、完善创建的文档
- 无论时创建钩子文件、指导文件还是规格文件等，你可以自己手动编写也可以通过与 AI 交互生成，也可以在 IDE 内的 Kiro 资源面板里面输入文本内容来生成
